...
typedef struct
{
    ...
    uint16 t12_exit_sum;
    uint8 t12_exit_state;
    uint8 t12_reacquire_confirm_count;
    uint16 t12_target_rate_x10;
    uint16 t12_actual_rate_x10;
    uint16 t12_rate_error_peak_x10;
    uint16 t12_exit_ratio_x1000;
    uint16 t12_exit_speed_scale_x1000;
    uint8 t12_mid_valid;
    uint16 t12_mid_angle_x10;
    uint16 t12_mid_target_rate_x10;
    uint16 t12_mid_actual_rate_x10;
    uint16 t12_mid_ratio_x1000;
...
static void track_test_report_event(void)
{
    ...
    if (event != TRACK_TEST_RESULT_IDLE)
    {
        ...
        track_result_snapshot.t12_exit_state = g_track_t12_exit_state;
        track_result_snapshot.t12_reacquire_confirm_count =
            g_track_t12_reacquire_confirm_count;
        track_result_snapshot.t12_target_rate_x10 = g_track_t12_target_rate_x10;
        track_result_snapshot.t12_actual_rate_x10 = g_track_t12_actual_rate_x10;
        track_result_snapshot.t12_rate_error_peak_x10 =
        ...
        track_result_snapshot.t12_mid_valid = g_track_t12_mid_valid;
        track_result_snapshot.t12_mid_angle_x10 = g_track_t12_mid_angle_x10;
        track_result_snapshot.t12_mid_target_rate_x10 =
            g_track_t12_mid_target_rate_x10;
        track_result_snapshot.t12_mid_actual_rate_x10 =
            g_track_t12_mid_actual_rate_x10;
        track_result_snapshot.t12_mid_ratio_x1000 =
            g_track_t12_mid_ratio_x1000;
...
static void guide_send_track_test_started(uint8 mode, int8 force_direction)
{
    ...
    reply_length = zf_sprintf(
        guide_reply_buffer,
        (const int8 *)"OK:TTEST Z09-10/T12R8 V120 T3000 G70/130/35 P22/28.5/6 K6/11.5@130/145 T145/172 X160/182 C3 B80 S80/35 TO180 M=%s\r\n",
        mode_text);
    if (reply_length >= GUIDE_REPLY_SIZE)
    {
        reply_length = GUIDE_REPLY_SIZE - 1U;
...
static void guide_send_runtime_config(void)
{
    ...
    guide_send_reply(
        "CFG2:RACE8 T10V180 T12V120 T3000 L120 R500 P22/28.5/6 G130 K6/11.5@130/145 T145/172 X160/182 C3 B80 S80/35 TO180 BK600 B70/55 LP25\r\n");
    guide_send_reply(
...
static uint8 send_track_test_result_frame(TrackTestResult result)
{
    ...
    if (track_result_snapshot.mode == TRACK_TEST_MODE_T12)
    {
        ...
        diagnostic_append_u32((const int8 *)"T12M:V=",
                              (uint32)track_result_snapshot.t12_mid_valid);
        diagnostic_append_u32((const int8 *)" A10=",
                              (uint32)track_result_snapshot.t12_mid_angle_x10);
        diagnostic_append_u32((const int8 *)" WT=",
                              (uint32)track_result_snapshot.t12_mid_target_rate_x10);
        diagnostic_append_u32((const int8 *)" WA=",
                              (uint32)track_result_snapshot.t12_mid_actual_rate_x10);
        diagnostic_append_u32((const int8 *)" TR=",
                              (uint32)track_result_snapshot.t12_mid_ratio_x1000);
        diagnostic_append_text((const int8 *)"", (const int8 *)"\r\n");
        ...
        diagnostic_append_u32((const int8 *)"T12C:ST=",
                              (uint32)track_result_snapshot.t12_exit_state);
        diagnostic_append_u32((const int8 *)" RC=",
                              (uint32)track_result_snapshot.t12_reacquire_confirm_count);
        diagnostic_append_u32((const int8 *)" WT=",
                              (uint32)track_result_snapshot.t12_target_rate_x10);
        diagnostic_append_u32((const int8 *)" WA=",
                              (uint32)track_result_snapshot.t12_actual_rate_x10);
        diagnostic_append_u32((const int8 *)" EP=",
