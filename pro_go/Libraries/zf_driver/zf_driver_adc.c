...
// 参数说明     count           转换次数
// 返回参数     void
// 使用示例     adc_mean_filter_convert (ADC_CH1_P11, 5);  //采集P11端口返回8位分辨率的AD值，采集五次取平均值
//-------------------------------------------------------------------------------------------------------------------
...
//  @return     void
//  Sample usage:               adc_convert(ADC_CH1_P11);
//-------------------------------------------------------------------------------------------------------------------
...
// 返回参数     void
// 使用示例     adc_init(ADC_CH1_P11, ADC_12BIT);//初始化P10引脚为ADC功能，12位分辨率
//-------------------------------------------------------------------------------------------------------------------
