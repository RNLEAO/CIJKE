...
uint8 xdata                 debug_uart_buffer[DEBUG_RING_BUFFER_LEN];           // 数据存放数组
#endif

fifo_struct xdata           debug_uart_fifo;

//static debug_output_struct  debug_output_info;
static volatile uint8 xdata zf_debug_init_flag = 1;
static volatile uint8 xdata zf_debug_assert_enable = 1;
